	                            ...
	                            <div class="single-product">
	                                <div class="product-f-image">
	                                    ...
	                                    <div class="product-hover">
	                                        ...
	                                        <a href="singleproduct?id=${sp.id }" class="view-details-link"><i class="fa fa-link"></i> See details</a>
	                                    </div>
	                                </div>
	                                
	                                <h2><a href="singleproduct?id=${sp.id }">${sp.tenSP }</a></h2>
	                                
	                                <div class="product-carousel-price">
	                                    <ins>${sp.giaMoi }</ins> <del>${sp.giaCu }</del>
	                                </div> 
	                            </div>
                            </c:forEach>
